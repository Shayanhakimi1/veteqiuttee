...
const Confirmation = () => {
  ...
  const { userData, selectedPet, consultationData, paymentData, clearAllData } = useApp();
  ...
  const handleNewConsultation = () => {
    ...
    localStorage.removeItem('petSelection');
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="bg-white rounded-lg p-4 border border-green-200">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-green-700 text-sm font-medium">تاریخ مشاوره</p>
              ...
              <div className="bg-white rounded-lg p-4 border border-green-200">
                <div className="flex items-center gap-3">
                  <span className="text-2xl">🕐</span>
                  <div>
                    <p className="text-green-700 text-sm font-medium">ساعت مشاوره</p>
        ...
        <div className="space-y-4">
          ...
          <div className="text-center pt-6 border-t border-gray-200">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-sm">
              ...
              <a 
                href="mailto:support@petconsultation.ir" 
                className="flex items-center gap-2 text-cyan-600 hover:underline"
              >
                ✉️ support@petconsultation.ir
              </a>
            </div>
          </div>
        </div>
