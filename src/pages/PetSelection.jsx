...
const PetSelection = () => {
  ...
  useEffect(() => {
    const savedSelection = localStorage.getItem('petSelection');
    if (savedSelection) {
      try {
  ...
  const handlePetSelect = (pet) => {
    ...
    localStorage.setItem('petSelection', JSON.stringify(pet));
  };
  ...
  const handleContinue = () => {
    ...
    // ذخیره انتخاب در context و localStorage
    savePetSelection(selectedPet);
