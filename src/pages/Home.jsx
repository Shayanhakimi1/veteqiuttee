        ...
        <div className="max-w-6xl mx-auto px-2 sm:px-4 py-2 sm:py-4">
          <div className="flex items-center justify-between flex-wrap gap-2">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                <h1 className="text-sm sm:text-lg md:text-xl font-bold text-gray-800">بیمارستان حیوانات خانگی</h1>
                <p className="text-xs sm:text-sm text-gray-600">دکتر حمیدرضا فتاحیان</p>
              </div>
            </div>
                  ...
                  <div key={slideIndex} className="w-full flex-shrink-0">
                    <div className="grid md:grid-cols-2 gap-6">
                      {specialists.slice(slideIndex * 2, slideIndex * 2 + 2).map((specialist) => (
                        <div key={specialist.id} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                          <div className="text-center">
                            ...
                            <p className="text-cyan-600 font-medium mb-2">{specialist.specialty}</p>
                            <p className="text-gray-500 text-sm mb-3">{specialist.experience}</p>
