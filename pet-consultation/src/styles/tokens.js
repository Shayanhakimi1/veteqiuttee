...
// مجموعه‌ای از توکن‌های طراحی برای سیستم طراحی یکپارچه
...
export const getBorderRadius = (size) => tokens.borderRadius[size] || size;
export const getBoxShadow = (size) => tokens.boxShadow[size] || size;
